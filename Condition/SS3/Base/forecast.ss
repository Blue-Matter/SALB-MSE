...
0.274 # SPR target (e.g. 0.40)
0.226 # Biomass target (e.g. 0.40)
...
#Albacore control rule shape (but not biomass; SS only does B/B0)
...
#0.25023 # Control rule Biomass level for constant F (as frac of Bzero, e.g. 0.40); (Must be > the no F level below)
...
2039  #FirstYear for caps and allocations (should be after years with fixed inputs) 

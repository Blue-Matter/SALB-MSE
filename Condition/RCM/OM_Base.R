...
# 
# Base Case - no stochastic parameters
...
saveRDS(OM_Base, "Condition/RCM/OM_Base_Logistic.om")
...
OM_Base_dome <- RCM_Base_dome@OM
OM_Base_dome <- Replace(OM_Base_dome, Generic_Obs)

saveRDS(OM_Base_dome, "Condition/RCM/OM_Base_Dome.om")

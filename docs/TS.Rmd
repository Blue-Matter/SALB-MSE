...
The model was run assuming logistic selectivity pattern for the long-line fleets (LL) and dome-shaped for the purse-seine (PS) and bait boats (BB; Table \@ref(tab:selectivity-table)).
